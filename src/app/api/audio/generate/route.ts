...
export async function POST(request: NextRequest) {
  try {
    ...
    // ── Mock Mode: return message instead of audio ──
    if (isMockMode()) {
      // Save to DB with mock flag
      ...
      return NextResponse.json({
        ...
        id: null,
        mockMode: true,
        mockMessage: 'Demo Mode — توليد الصوت يحتاج مفتاح OpenAI API. أضف OPENAI_API_KEY وغيّر AI_PROVIDER=openai',
      })
    }
